...
export const competitors = { id: 1, name: 'Example Competitor', website: 'https://example.com', createdAt: new Date() } as Competitor;
...
export const products = { id: 1, name: 'Example Product', description: 'Example description', categoryId: 1, brandId: 1, createdAt: new Date() } as Product;
...
export const catalogProducts = { id: 1, name: 'Example Catalog Product', description: 'Example description', categoryId: 1, brandId: 1, createdAt: new Date() } as CatalogProduct;
export const competitorListings = { id: 1, competitorId: 1, productId: 1, url: 'https://example.com', price: 100, currency: 'USD', createdAt: new Date() } as CompetitorListing;
export const listingSnapshots = { id: 1, listingId: 1, price: 100, currency: 'USD', timestamp: new Date(), createdAt: new Date() } as ListingSnapshot;
export const listingImages = { id: 1, listingId: 1, url: 'https://example.com/image.jpg', altText: 'Example image', createdAt: new Date() } as ListingImage;
...
export class DrizzleStorage implements IStorage {
  ...
  async createCompetitor(competitor: any): Promise<Competitor> {
    return { ...competitors, ...competitor, id: Date.now() };
  }
